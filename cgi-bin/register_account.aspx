<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="register_account.aspx.cs" Inherits="zaartech.anabiya.cgi_bin.register_account" %>
        ...
        <section class="register_section sec_space_small">
          <div class="container">
            <div class="register_form_wrap text-center dashboard_wrap">
              ...
              <div class="checkbox_item text-start">
                <input id="terms_checkbox" type="checkbox">
                <label for="terms_checkbox">I agree to the <a href="#!">Terms of User</a></label>
              </div>
              <button type="submit" class="btn btn_primary btn_rounded">Create Account</button>
              <p class="mb-0">
                Already have an account?
                <strong class="d-block"><a class="login_btn" href="register_login.aspx">LOGIN</a></strong>
              </p>
