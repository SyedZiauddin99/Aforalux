<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="order_tracking.aspx.cs" Inherits="zaartech.anabiya.cgi_bin.order_tracking" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="body_wrap">
      ...
      <main>
        ...
        <!--<section class="breadcrumb_section breadcrumb_2" style="background-image: url(/assets/images/breadcrumb/breadcrumb_bg_3.jpg);">
          <div class="container">
            <div class="breadcrumb_content">
              <h1 class="page_title text-uppercase">Order Tracking</h1>
        ...
        ================================================== -->
        <div class="order_tracking_section sec_space_small pb-0" style="padding-top:40px!important;">
          <div class="container">
            <ul class="dashboard_nav ul_li_center">
              <li><a href="cart.aspx">Shoping Cart <span>3</span></a></li>
              <li><a href="wishlist.aspx">Wishlist <span>5</span></a></li>
              <li class="active"><a href="order_tracking.aspx">Order Tracking</a></li>
            ...
            <div class="row justify-content-center">
              <div class="col col-lg-8">
                <div class="order_tracking_form text-center">
                  ...
                  <form action="#">
                    <div class="form_item">
                      <span class="input_title">Order ID</span>
                      <input type="text" name="order_id" placeholder="Found in your order confirmation email">
                    </div>
                    <div class="form_item">
                      <span class="input_title">Billing Email</span>
                      <input type="text" name="order_id" placeholder="Email you used during checkout">
                    </div>
                    <button type="submit" class="btn btn_primary btn_rounded">Track</button>
                  </form>
                </div>
              </div>
            </div>
