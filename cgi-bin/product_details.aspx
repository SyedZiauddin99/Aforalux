<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="product_details.aspx.cs" Inherits="zaartech.anabiya.cgi_bin.product_details" %>
                        ...
                        <div class="row align-items-center justify-content-center">
                            <div class="col col-lg-7 col-md-8">
                                <div class="sd_image_carousel">
                                    <div class="sd_carousel_wrap" data-slick='{"dots": false}'>
                                        ...
                                        <div class="slider_item">
                                            <img src="/assets/images/details/shop_details_img_2.jpg" alt="image_not_found">
                                        </div>
                                        <div class="slider_item">
                                            <img src="/assets/images/details/shop_details_img_3.jpg" alt="image_not_found">
                                        </div>
                                        <div class="slider_item">
                                            <img src="/assets/images/details/shop_details_img_1.png" alt="image_not_found">
                                        </div>
                            ...
                            <div class="col col-lg-5 col-md-8">
                                <div class="shop_details_content">
                                    ...
                                    <h3 class="item_title">Flora</h3>
                                    <div class="item_price">
                                        <span class="sale_price">Rs. 855.99</span>
                                        <del>Rs. 130.00</del>
                                    </div>
                                    <p class="mb-0">
                                    ...
                                    <div class="sd_info_layout">
                                        ...
                                        <form action="#" style="width:100%">
                                            <ul class="nav child_image" role="tablist" style="font-size:14px!important">
                                                ...
                                                <li role="presentation" style="padding-top:5px;padding-left:5px;width:20%;">
                                                    <span style="outline:1px solid gray;padding:10px;background-color:white;">SMALL</span>
                                                </li>
                                                <li role="presentation" style="padding-top:5px;padding-left:4px;width:20%;">
                                                    <span style="outline:1px solid gray;padding:10px;background-color:white;">MEDIUM</span>
                                                </li>
                                                <li role="presentation" style="padding-top:5px;padding-left:5px;width:20%;">
                                                    <span style="outline:1px solid gray;padding:10px;background-color:white;">QUEEN</span>
                                                </li>
                                                <li role="presentation" style="padding-top:5px;padding-left:9px;width:20%;">
                                                    <span style="outline:1px solid gray;padding:10px;background-color:white;">KING</span>
                                                </li>
                                                <li role="presentation" style="padding-top:5px;padding-left:5px;width:20%;">
                                                    <span></span>
                                                </li>
                                    ...
                                    <ul class="sd_btns_group ul_li">
                                        ...
                                        <li><a class="btn btn_primary btn_rounded text-uppercase" href="cart.aspx">Add To Cart</a></li>
                                    </ul>
