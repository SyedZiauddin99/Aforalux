<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminMaster.Master" AutoEventWireup="true" CodeBehind="viewcategory.aspx.cs" Inherits="aforalux.Admin.viewcategory" %>
        ...
        <div class="container">
            ...
            <asp:DataList runat="server" ID="dtcategory" Width="100%" OnItemCommand="dtcategory_ItemCommand"  OnItemDataBound="dtcategory_ItemDataBound" >
                ...
                <HeaderTemplate>
                    <div class="row">
                         <div class="col col-1">
                            <asp:Label runat="server" ID="headcatId" Text='Cat Id'></asp:Label>
                        </div>
                        <div class="col col-2">
                             <asp:Label runat="server" ID="headcatimage"  Text="Cat Image"></asp:Label>
                        </div>
                       
                        <div class="col col-2">
                             <asp:Label runat="server" ID="headcatname"  Text="Cat Name"></asp:Label>
                        </div>
                        <div class="col col-4">
                             <asp:Label runat="server" ID="headcatdesc"  Text="Cat Description"></asp:Label>
                        </div>
                ...
                <ItemTemplate>
                    <div class="row mt-2 mb-2">
                         <div class="col col-1">
                            ...
                            <asp:Label runat="server" ID="catId" Text='<%#Eval("cat_id") %>'></asp:Label>
                        </div>
                        <div class="col col-2">
                            <img src="../assets/images/category/<%# Eval("cat_image") %>" class="img-fluid" />
                        </div>
                       
                        <div class="col col-2">
                             <asp:Label runat="server" ID="catname"  Text='<%#Eval("cat_name") %>'></asp:Label>
                        </div>
                        <div class="col col-4">
                             <asp:Label runat="server" ID="catdesc"  Text='<%#Eval("cat_description") %>'></asp:Label>
                        </div>
                        <div class="col col-1">
